...
INSERT INTO `sys_resource` (`name`, `category_id`, `type`, `url`, `status`, `remark`, `create_date`, `create_user`, `update_date`, `update_user`) VALUES ('重置用户密码', (select t.id from (select id from sys_resource_category where name = '用户管理') t), '1', '/ajax/system/user/resetPassword', '0', '', now(), 'admin', now(), 'admin');
...
-- 菜单初始化数据
INSERT INTO `sys_menu` (`name`, `parent_id`, `resource_id`, `icon_class`, `sort`, `status`, `remark`, `create_date`, `create_user`, `update_date`, `update_user`) VALUES ('系统菜单', '0', NULL, NULL, '0', '0', '系统菜单', now(), 'admin', now(), 'admin');
INSERT INTO `sys_menu` (`name`, `parent_id`, `resource_id`, `icon_class`, `sort`, `status`, `remark`, `create_date`, `create_user`, `update_date`, `update_user`) VALUES ('系统管理', (select t.id from (select id from sys_menu where parent_id = 0) t), NULL, 'fa-bookmark', '1', '0', '', now(), 'admin', now(), 'admin');
